            ...
            <div className="space-y-2">
              {CAMP_STATUSES.map(s => (
                <button key={s} onClick={() => handleUpdateStatus(statusModal._id, s)}
                  className={`w-full py-2.5 rounded-xl font-semibold text-sm text-left px-4 transition-all border ${statusModal.status === s ? "bg-red-600 text-white border-red-600" : "border-gray-200 text-gray-700 hover:bg-gray-50"
                    }`}>
